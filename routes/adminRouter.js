...
router.get(
  ...
  requireSignin,
  adminMiddleware,
  adminController.couponmanagement
);
router.get(
  "/addCoupon",
  requireSignin,
  adminMiddleware,
  adminController.addCouponForm
);
router.get(
  "/editCoupon",
  requireSignin,
  adminMiddleware,
  adminController.editCouponForm
);
router.post(
  "/listcoupon/:id",
  requireSignin,
  adminMiddleware,
  couponmanagement.listcoupon
);
router.post(
  "/unlistcoupon/:id",
  requireSignin,
  adminMiddleware,
  couponmanagement.unlistcoupon
);
router.post(
  "/addincoupon",
  requireSignin,
...
router.get(
  ...
  requireSignin,
  adminMiddleware,
  adminController.bannermanagement
);
router.get(
  "/addBannerpage",
  requireSignin,
...
router.post(
  "/addBanner",
  Banner.uploadBanner.single("banner"),
